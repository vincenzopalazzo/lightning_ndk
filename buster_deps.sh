...
sudo apt-get -yqq install python3 python3-{pip,virtualenv,mako,dev} curl build-essential libtool autotools-dev automake pkg-config bsdmainutils unzip git gettext libssl-dev libffi-dev libpython2.7-dev
